...
1. Сделать скрипт для а, - -- обработки текста 'Войны и мира', который бы y'a выходе выдавал две таблицы:

- -- ТОП20 самых популярных а,  - -- букв русского афавита (без учета сносок в тексте) в виде массива 'буква' => 'кол-во упоминаний';
- -- ТОП20 самых популярных а, слов в книге (без учета сносок в тексте), язык значения не имеет. Словом считать любую последовательность а, а, а, а, а, а цифр,
  букв и символов длиннее 2 - --  знаков и отделенных пробелами. y'a выходе должен получится массив вида 'слово' => 'количество упомиy'aний'
...
- -- сделать функцию, которая y'a вход - -- принимает двумерный массив и выводит его в консоли или в браузере в виде ASCII-таблицы. Ключи массива - -- названия столбцов, значения - ячейки
Пример:
...
P.S. Очень важно учитывать краевые случаи, код желательно писать 'боевой', т.е. с нормальной струкрутой, названиями переменных, проверками различных условий и т.п.";*/
    ...
    if( $f ){
        ...
        $result['top20Word'] = ResultArray(AnalysisTop20($f));
